...
namespace AuthenticatorPro.Test
{
    public class AuthenticatorTest
    {
        ...
        [InlineData("otpauth://totp/Big%20Company%3AMy%20User?secret=ABCDEFG&issuer=Big%20Company")] // Encoded username issuer pair 
        ...
        [InlineData("otpauth://totp/issuer%3Ausername?secret=ABCDEFG&issuer=issuer&algorithm=SHA512")] // Algorithm parameter
        ...
        [Theory]
        [InlineData("abcdefg", "ABCDEFG", AuthenticatorType.Totp, AuthenticatorType.Hotp, AuthenticatorType.SteamOtp)] // Make uppercase
        [InlineData("ABCD EFG", "ABCDEFG", AuthenticatorType.Totp, AuthenticatorType.Hotp, AuthenticatorType.SteamOtp, AuthenticatorType.MobileOtp)] // Remove spaces
        [InlineData("ABCD-EFG", "ABCDEFG", AuthenticatorType.Totp, AuthenticatorType.Hotp, AuthenticatorType.SteamOtp, AuthenticatorType.MobileOtp)] // Remove hyphens 
        ...
        [Theory]
        [InlineData(null, false, AuthenticatorType.Totp, AuthenticatorType.Hotp, AuthenticatorType.SteamOtp, AuthenticatorType.MobileOtp)] // Missing 1/2 
        [InlineData("", false, AuthenticatorType.Totp, AuthenticatorType.Hotp, AuthenticatorType.SteamOtp, AuthenticatorType.MobileOtp)] // Missing 2/2
        [InlineData("ABCDEFG", true, AuthenticatorType.Totp, AuthenticatorType.Hotp, AuthenticatorType.SteamOtp)] // Valid base32 (uppercase)
        [InlineData("abcdefg", true, AuthenticatorType.Totp, AuthenticatorType.Hotp, AuthenticatorType.SteamOtp)] // Valid base32 (lowercase)
        [InlineData("abcdefg==", true, AuthenticatorType.Totp, AuthenticatorType.Hotp, AuthenticatorType.SteamOtp)] // Valid base32 (padding)
        [InlineData("a", false, AuthenticatorType.Totp, AuthenticatorType.Hotp, AuthenticatorType.SteamOtp)] // Too few bytes base32
