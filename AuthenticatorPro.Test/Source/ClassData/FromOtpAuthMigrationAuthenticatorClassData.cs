    ...
    internal class FromOtpAuthMigrationAuthenticatorClassData : IEnumerable<object[]>
    {
        ...
        { 
            ...
            yield return new object[]
            {
                ...
                new Authenticator { Type = AuthenticatorType.Totp, Secret = "ABCDEFG", Issuer = "issuer", Username = "username", Algorithm = Algorithm.Sha1 }
            };
            ...
            yield return new object[]
            {
                ...
                new Authenticator { Type = AuthenticatorType.Hotp, Secret = "ABCDEFG", Issuer = "issuer", Username = "username", Algorithm = Algorithm.Sha1, Counter = 10 }
            };
            ...
            yield return new object[]
            {
                ...
                new Authenticator { Type = AuthenticatorType.Totp, Secret = "ABCDEFG", Issuer = "username", Username = null, Algorithm = Algorithm.Sha1 }
            };
