...
{
    [Activity(Label = "@string/displayName", Theme = "@style/LightTheme", MainLauncher = true,
    ...
    public class ActivityMain : AppCompatActivity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            var overlay = LayoutInflater.Inflate(Resource.Layout.qrCode, null);
        ...
        private void DrawerItemSelected(object sender, NavigationView.NavigationItemSelectedEventArgs e)
        {
            switch(e.MenuItem.ItemId)
            {
                case Resource.Id.drawerSettings:
                    _actionBarDrawerToggle.IdleAction = () => { StartActivity(typeof(ActivitySettings)); };
                    break;

                case Resource.Id.drawerEditCategories:
                    _actionBarDrawerToggle.IdleAction = () => { StartActivity(typeof(ActivityEditCategories)); };
                    break;

                case Resource.Id.drawerRestore:
                    _actionBarDrawerToggle.IdleAction = () => { StartActivity(typeof(ActivityRestore)); };
                    break;

                case Resource.Id.drawerBackup:
                    _actionBarDrawerToggle.IdleAction = () => { StartActivity(typeof(ActivityBackup)); };
                    break;
        ...
        {
            var menu = new PopupMenu(this, _addButton);
        ...
        private void OpenCategoriesDialog(int position)
        {
            ...
            _categoriesDialog =
                new DialogChooseCategories(_categorySource, CategoriesDialogOnClose, CategoriesDialogOnClick, position,
