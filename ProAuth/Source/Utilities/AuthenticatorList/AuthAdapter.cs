...
{
    internal sealed class AuthAdapter : Android.Support.V7.Widget.RecyclerView.Adapter, IAuthAdapterMovement
    {
        ...
        public override void OnBindViewHolder(Android.Support.V7.Widget.RecyclerView.ViewHolder viewHolder, int position, IList<Java.Lang.Object> payloads)
        {
